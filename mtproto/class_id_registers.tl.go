...
var clazzIdRegisters2 = map[int32]func() TLObject{
	...
	571713117: func() TLObject { // 0x2213a65d
		o := MakeTLExplore(nil)
		o.Data2.Constructor = 571713117
		return o
	},
	...
	213559549: func() TLObject { // 0xcbaa8fd
		o := MakeTLPageContent(nil)
		o.Data2.Constructor = 213559549
		return o
	},
	...
	-1171539660: func() TLObject { // 0xba2bb934
		o := MakeTLUser(nil)
		o.Data2.Constructor = -1171539660
		return o
	},
	...
	900851008: func() TLObject { // 0x35b1e540
		o := MakeTLUserData(nil)
		o.Data2.Constructor = 900851008
		return o
	},
	...
	1379281804: func() TLObject { // 0x52362b8c
		return &TLAuthSignUp{
			Constructor: 1379281804,
		}
	},
	...
	1896062014: func() TLObject { // 0x71039c3e
		return &TLAuthSignIn{
			Constructor: 1896062014,
		}
	},
